...
A comprehensive Flutter video player plugin with native iOS and Android implementations. This plugin provides advanced video playback capabilities, download management, and iOS screen protection features.

**Package:** uz.shs.video_player
**Version:** 2.0.0
**Repository:** https://github.com/SunnatilloShavkatov/video_player.git
...
#### Flutter Layer
- **VideoPlayer**: Main API class for video playback and downloads
- **VideoPlayerView**: Embedded video player widget for Flutter UI
- **PlayerConfiguration**: Configuration model for video playback
- **DownloadConfiguration**: Configuration model for video downloads
...
- **AVAssetDownloadURLSession**: Background download manager
...
- Test video playback from URL, assets, and downloaded files
...
- Downloads use native background sessions (iOS) and ExoPlayer (Android)
